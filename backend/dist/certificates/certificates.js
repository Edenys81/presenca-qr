 ...
 */
export async function generateCertificatePDF(studentId, eventId, attendanceId) {
    try {
        ...
        yPosition -= 50;
        page.drawText(`Matrícula: ${student.matricula} | Curso: ${student.curso}`, {
            x: 50,
            y: yPosition,
            size: 11,
            font: contentFont,
        ...
        const { url: certificateUrl } = await storagePut(fileName, pdfBytes, "application/pdf");
 ...
 */
export async function validateCertificate(validationCode) {
    try {
